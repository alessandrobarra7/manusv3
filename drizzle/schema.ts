...
export const audit_log = mysqlTable("audit_log", {
  ...
  user_id: int("user_id"),
  unit_id: int("unit_id"),
  action: mysqlEnum("action", ["LOGIN", "LOGOUT", "VIEW_STUDY", "OPEN_VIEWER", "CREATE_REPORT", "UPDATE_REPORT", "SIGN_REPORT", "CREATE_USER", "UPDATE_USER", "DELETE_USER", "CREATE_UNIT", "UPDATE_UNIT", "DELETE_UNIT"]).notNull(),
